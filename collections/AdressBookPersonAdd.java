...
public class AdressBookPersonAdd extends JFrame implements ActionListener {
	
	private JTextField field[];
	private JLabel label;
	
	public AdressBookPersonAdd() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getActionCommand().equals("add")){
			...
			if(flatnumber != -1){
				new Person(field[0].getText(), field[1].getText(), field[2].getText(), housenumber, flatnumber, field[5].getText(), field[6].getText());
			}
			else
				new Person(field[0].getText(), field[1].getText(), field[2].getText(), housenumber, field[5].getText(), field[6].getText());
